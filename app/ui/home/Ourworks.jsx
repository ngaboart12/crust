  ...
  return (
    <div className="w-full max-w-7xl py-20 px-[20px] md:px-[85px] flex flex-col gap-20">
      <div className="flex flex-col md:flex-row gap-10 md:gap-20 items-center">
        ...
        <div>
          <span className="text-[18px] font-flat text-center text-black ">
            ...
            post events must be in our clients’ best interests.
          </span>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-6 items-center justify-center ">
        <div className="flex flex-row gap-4 items-center">
          <h1 className="text-[30px] text-[#F9A21B]">1</h1>
        ...
        <div className="flex flex-row gap-4 items-center">
          <h1 className="text-[30px] text-[#F9A21B]">3</h1>
          <div className="flex flex-col">
            <h1 className=" text-[#F9A21B] font-flat text-[18px]">
      ...
      <div className="flex flex-col md:flex-row w-full items-center justify-center gap-6">
        <div className="flex flex-row gap-4 items-center">
          <h1 className="text-[30px] text-[#F9A21B]">4</h1>
          <div className="flex flex-col">
            <h1 className=" text-[#F9A21B] font-flat text-[18px]">
              Designing and Planning
            </h1>
        ...
        <div className="flex flex-row gap-4 items-center">
          <h1 className="text-[30px] text-[#F9A21B]">5</h1>
          <div className="flex flex-col">
            <h1 className=" text-[#F9A21B] font-flat text-[18px]">
              Designing and Planning
            </h1>
