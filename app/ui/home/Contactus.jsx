...
const Contactus = () => {
  return (
    <div className=" relative " id="contactus">
      <div className="w-full relative flex px-2 sm:px-20 py-10 justify-center font-flat ">
        <div className="flex z-40   flex-col w-full py-20 px-[10px]  md:p-10 gap-10  bg-transparent items-start  md:items-center md:justify-center">
          <h1 className="text-[#F59620] text-[24px] font-bold font-outfit ">
          ...
          <div className="flex flex-col  lg:flex-row items-start  md:justify-center md:items-center gap-10">
            ...
            <div className="flex w-full items-center justify-center">
              <form className="sm:max-w-lg mx-auto w-full flex flex-col gap-4">
                <div className="flex flex-row gap-2">
                  <input
                    type="text"
                    className={`
                }font-[300] border rounded-lg py-4 px-5 outline-none text-black font-sans placeholder:text-[#CACACA] font-[300] w-full`}
                ...
                <button
                  type="submit"
                  className=" font-sans  bg-[#F59620] w-full py-3.5 px-2 text-white rounded-lg mt-10 flex justify-center items-center"
                >
                  Send Message
                </button>
              </form>
